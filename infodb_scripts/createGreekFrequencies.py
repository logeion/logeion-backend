...
def main():
    ...
    usage = 'Usage: %s [GREEKINFODB]' % prog
    dbname = 'greekInfo.db'
    if len(sys.argv[1:]) > 1:
    ...
    f = urllib2.urlopen("http://perseus.uchicago.edu/cgi-bin/GreekFrequency.pl?author=&title=&genre=&editor=&displaymorethan=49&displaylessthan=1000000&sortby=decreasingFreq&searchby=searchbylemma&language=NOT+English")
